...
export const metadata: Metadata = {
  ...
  description: "Transform your business transportation with GrnLYFT's eco-friendly electric vehicle fleet services in India. Reduce costs, lower emissions, and improve operational efficiency with our sustainable B2B transportation solutions.",
  keywords: "EV transportation, electric fleet, business transportation, sustainable transport, B2B transportation, green transportation, India transportation, electric vehicles, EV fleet management, corporate transportation, zero-emission fleet, sustainable business solutions, Atmanirbhar Bharat, Make in India, eco-friendly transportation",
  ...
  openGraph: {
    ...
    siteName: "GrnLYFT",
    title: "GrnLYFT - Sustainable B2B EV Transportation Solutions in India",
    description: "Transform your business transportation with sustainable electric vehicle fleet solutions. Eco-friendly, efficient, and reliable corporate transportation services across India.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    description: "Transform your business transportation with sustainable electric vehicle fleet solutions across India.",
    images: ["/og-image.jpg"],
    site: "@grnlyft",
    creator: "@grnlyft",
  },
