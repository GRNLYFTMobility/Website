...
This message was sent from the GrnLYFT website contact form.
      `;
      
      // Encode for URL
      const mailtoUrl = `mailto:info@grnlyft.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className={`transition-all duration-700 delay-200 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className={`p-8 rounded-lg shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white border border-gray-200'}`}>
                <h3 className={`text-2xl font-semibold mb-6 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Send us a message</h3>
                
                {submitSuccess && (
                  <div className="mb-6 p-4 bg-green-100 border-l-4 border-green-500 text-green-700 rounded">
                    <p>Email client opened! Please send the email to complete your message submission.</p>
                  </div>
                )}
            ...
            <div className={`transition-all duration-700 delay-400 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className={`h-full flex flex-col justify-between ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className={`text-lg font-medium mb-1 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                          Office Address
                        </h4>
                        <a 
                          ...
                          className={`hover:text-green-600 transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}
                        >
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a 
                          ...
                          className={`block hover:text-green-600 transition-colors duration-300 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}
                        >
                          +91 96633 77673
                        </a>
                        <a 
